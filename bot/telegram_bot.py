...
#     print(tb.get_me())
    ...
    # print(tb.send_message_to_group('Este es el segundo mensaje de prueba al grupo'))
    # print(tb.send_message_to_channel('Este es el primer mensaje de prueba al canal'))
    # print(tb.send_photo_to_channel('./army.jpg', 'Pistola detectada'))
